...
def _check_validity(new_artifact: metadata_store_pb2.Artifact,
  ...
  if multiple_artifacts:
    # If there are multiple artifacts in the executor output, their uri should
...
def publish_succeeded_execution(
  ...
  if executor_output:
    ...
    for key, artifact_list in output_artifacts.items():
      ...
      multiple_artifacts = len(updated_artifact_list) > 1
      for proto_artifact in updated_artifact_list:
        _check_validity(proto_artifact, original_artifact, multiple_artifacts)
